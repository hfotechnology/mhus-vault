...
public interface CherryVaultApi {
    ...
    /**
     * Creates a new secret using the group secret generator and process the secret by the target
     * processors.
     *
    ...
    default String importSecret(String groupName, String secret, String[] index) throws MException {
        return importSecret(
                ...
                null,
                null,
                new SecretContent(new SecureString(secret), new MProperties()),
                new MProperties(),
                index);
    }
    ...
    List<VaultEntry> search(String group, String target, String[] index, int size, boolean all)
            throws MException;
