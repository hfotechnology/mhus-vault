...
public class VaultTarget extends DbMetadata {
    ...
    @DbPersistent private String processorName;
    @DbPersistent private MProperties processorConfig;
    @DbPersistent private String conditionNames;
    @DbPersistent private MProperties conditionConfigs;
