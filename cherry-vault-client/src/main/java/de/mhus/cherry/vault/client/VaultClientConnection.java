...
public class VaultClientConnection {
	...
	public VaultClientConnection(String url, String user, String password) throws UnsupportedEncodingException {
		this.url = url;
	...
	/*
{
  ...
  "modifydate_" : "2018-01-24T22:39:20"
	...
	public String importSecret(String group, String secret, Map<String,Object> parameters) throws IOException {
		// open url and read content
	...
	public void importUpdate(String secretId, String secret, Map<String,Object> parameters) throws IOException {
		// open url and read content
		String u = url + "/rest/vault";
		URL url = new URL(u);
        HttpURLConnection connection = (HttpURLConnection) url.openConnection();
