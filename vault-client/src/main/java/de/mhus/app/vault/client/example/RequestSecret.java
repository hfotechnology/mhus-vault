 ...
 */
package de.mhus.app.vault.client.example;

import java.io.IOException;
import java.util.UUID;

import de.mhus.app.vault.client.DsaSigner;
import de.mhus.app.vault.client.RsaCipher;
import de.mhus.app.vault.client.SecretEntry;
import de.mhus.app.vault.client.VaultClientConnection;
...
public class RequestSecret {
    ...
    public static void main(String[] args) throws IOException, MException {
        ...
        SecretEntry entry =
                con.getSecret(UUID.fromString("7d693d2c-6474-4f7f-a734-7a77e906e7df"), "test");
